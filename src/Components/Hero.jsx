...
const Hero = () => {
  return (
    <BannerComponent parentStyle="h-[44rem] sm:h-[34rem] flex items-center container mx-auto px-10 flex-col md:flex-row px-4 py-10 sm:px-6 lg:max-w-7xl lg:px-8" para="Best furniture for your castle..." title="New furniture collection trends in 2024" />
