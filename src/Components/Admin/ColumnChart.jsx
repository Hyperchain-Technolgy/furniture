    ...
    <div className="w-full rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
      <div className="flex justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center">
          ...
          <div>
            <h5 className="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-1">2,340</h5>
            <p className="text-sm font-normal text-gray-500 dark:text-gray-400">New products this week</p>
          </div>
        </div>
        <div
