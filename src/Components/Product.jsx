...
const Product = ({ src, price }) => {
  return (
    <section section className="border w-72 min-w-64 group hover:cursor-pointer" >
      ...
      <div className='font-medium group-hover:bg-foreground duration-300 p-3'>
        ...
        <div className='flex gap-2 items-center'>
          ...
          <span class="inline-flex items-center rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-pink ring-1 ring-inset ring-red-600/10 group-hover:bg-blue-900 group-hover:ring-blue-50/10 group-hover:text-white">-20%</span>
        </div>
      </div>
    </section >
  )
